...
if (document.querySelector('body').classList.contains('mainPage') || document.querySelector('.reviews')) {
  ...
  $('.packages__slider').slick({
    ...
    infinite: true,
    centerMode: true,
    prevArrow: '<button class="packages__prev"> <i class="fas fa-chevron-left">&#60</i> </button>',
    nextArrow: '<button class="packages__next"> <i class="fas fa-chevron-right">&#62</i></button>',
    variableWidth: true
  })
